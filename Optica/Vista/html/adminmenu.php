...
<head>
    ...
    <title>Sistema de manejo de Optica</title>
            ...
            <div class="collapse navbar-collapse col-8  " id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item active">
                        <a class="nav-link" id="letra" href="adminproductos.html">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="letra" href="adminCitas.html">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="letra" href="<?php echo URL ?>/usuario/mostrarcontrolador" >
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="letra" href="reportes.html">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
